...
export enum ErrorCode {
    ...
    CommoditiesDescriptorSupplementaryUnitMissing = "EUDR_COMMODITIES_DESCRIPTOR_SUPPLEMENTARY_UNIT_MISSING",
    Commodities_DESCRIPTOR_NUMBER_OF_UNITS_MISSING = "EUDR_COMMODITIES_DESCRIPTOR_NUMBER_OF_UNITS_MISSING",
    CommoditiesSpeciesInformationCommonNameEmpty = "EUDR_COMMODITIES_SPECIES_INFORMATION_COMMON_NAME_EMPTY",
    CommoditiesSpeciesInformationScientificNameEmpty = "EUDR_COMMODITIES_SPECIES_INFORMATION_SCIENTIFIC_NAME_EMPTY",
    ActivityTypeNotAllowedForNonEUOperator = "EUDR_ACTIVITY_TYPE_NOT_ALLOWED_FOR_NON_EU_OPERATOR"
}